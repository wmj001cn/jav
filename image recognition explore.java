...
public class PHash {
	...
	public static void main(String[] args) {
		...
		String i1p = "E:\\sample\\Desert - Copy.jpg";
		File img0 = new File(i1p);
		String i2p = "E:\\sample\\Koala.jpg";
		File img1 = new File(i2p);
		
		String hash = getFeatureValue(i1p);
		String hash1 = getFeatureValue(i2p);
